...
<template>
    <ContentContainer classes="p-0 px-0">
        <div class="w-full h-full flex">
            <aside
                :class="`${currentTheme.backgroundTwo} w-64 h-full flex flex-col gap-2 p-6 transition-all duration-300 ease-out`">
            ...
            <main
                :class="`${currentTheme.background} w-full h-full bg-[#333537] p-6 rounded-tl-lg transition-all duration-300 ease-out`">
                <RouterView />
            </main>
        </div>
    </ContentContainer>
